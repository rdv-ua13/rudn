...
<div class="container">
	<div class="page-wrapper">
		...
		<section class="page-content enrollment">
			...
			<h1 class="page-content__title">Аспирантура</h1>

			<div class="block-mb-medium">
				<div class="enrollment-top-img" style="background-image: url('/build/img/enrollment-graduate-school-img1.png')"></div>
			</div>
			<div class="block-mb-medium">
				<div class="text-block">
					<p>Аспирантура – уровень высшего образования, следующий после бакалавриата, позволяющий углубить знания по определенному направлению подготовки.</p>
